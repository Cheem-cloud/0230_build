        ...
        Task {
            do {
                ...
                let hangoutData: [String: Any] = [
                    ...
                    "endDate": Timestamp(date: date.addingTimeInterval(duration.rawValue)),
                    "location": location,
                    "creatorID": userId,
            ...
            Group {
                if isLoading {
                    ...
                    ContentUnavailableView(
                        ...
                        description: Text("You don't have any connections yet.")
                    )
                } else {
                    List {
            ...
            Group {
                if isLoading {
                    ...
                    ContentUnavailableView(
                        "No Personas Found",
                        systemImage: "person.slash",
                        description: Text("You haven't created any personas yet.")
                    )
                } else {
                    List {
            ...
            Group {
                if isLoading {
                    ...
                    ContentUnavailableView(
                        "No Personas Found",
                        systemImage: "person.slash",
                        description: Text("Your friend hasn't created any personas yet.")
                    )
                } else {
                    List {
                        ForEach(personas) { persona in
